...
func toAuditModels(value audit.Record) (requestAuditModel, []requestAuditAttemptModel, error) {
	...
	row := requestAuditModel{
		...
		ContextInputTokens: nonNegative(value.ContextInputTokens), ContextOutputTokens: nonNegative(value.ContextOutputTokens), FirstTokenMS: normalizedFirstToken(value),
		UpstreamOutputTPS: value.UpstreamOutputTPS, DurationMS: nonNegative(value.DurationMS),
